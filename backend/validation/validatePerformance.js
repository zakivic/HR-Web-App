...
if (performanceReview.employee && !mongoose.Types.ObjectId.isValid(performanceReview.employee)) {
...
if (performanceReview.manager && !mongoose.Types.ObjectId.isValid(performanceReview.manager)) {
errors.push({ field: 'manager', message: 'Invalid Manager ID' });
}

// Check if strengths, areas for improvement, and goals are provided
if (performanceReview.strengths && performanceReview.areasForImprovement && performanceReview.goals) {
...
if (performanceReview.overallRating && (typeof performanceReview.overallRating !== 'number' || performanceReview.overallRating < 1 || performanceReview.overallRating > 5)) {
