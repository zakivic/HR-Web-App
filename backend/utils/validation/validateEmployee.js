...
export const validateEmployee = (employee) => {
  ...
  if (
    ...
    !allowedMartialStatuses.includes(employee.martialStatus)
  ) {
  ...
  if (
    ...
    !allowedMilitaryStatuses.includes(employee.militaryStatus)
  ) {
    errors.push({
      field: "militaryStatus",
      message: "Invalid Military Status",
    });
  }

  if (
    employee.educationStatus &&
    !allowedEducationStatuses.includes(employee.educationStatus)
  ) {
    errors.push({
      field: "educationStatus",
      message: "Invalid Education Status",
    });
  }
  ...
  if (
    employee.department &&
    !mongoose.Types.ObjectId.isValid(employee.department)
  ) {
